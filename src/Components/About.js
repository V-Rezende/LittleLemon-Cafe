    ...
    return (
        <div className="about">
            <div className="about-title">
                <img src="/Images/logo.nav.png" alt="About Logo"/>
                <h1>| About us:</h1>
            </div>
            <div className="about-content">
                ...
                <p>Join us at Little Lemon Café, where every dish tells a story, and every visitor becomes a part of our extended family. Experience the warmth of Brazilian hospitality and the vibrant flavors that have made Little Lemon Café a cherished gem in the heart of Gold Coast.</p>
                <p>Obrigado for being a part of our journey since 2003!</p>
            </div>
        </div>
    )
}
